...
<table class="invoice-breakdown">
 ...
 <br>
    ...
    <table class="bank-info">
        ...
        <tr>
            <th>Bank Address</th>
            <td colspan="2">Etihad Airways Centre 5th Floor, Abu Dhabi, UAE</td>
        </tr>
        <tr>
            <th>Account Number</th>
            <td colspan="2">9922074309</td>
        </tr>
        <tr>
            <th>Account Type</th>
            <td colspan="2">USD</td>
        ...
        <tr>
            <th>IBAN</th>
            <td colspan="2">AE100860000009922074309</td>
        </tr>
        <tr>
            <th>SWIFT Code</th>
            <td colspan="2">WIOBAEADXXX</td>
        </tr>
        </table>
