...
$query = "SELECT id.due_id, id.course_date, id.num_participants, id.days, id.due_amount,
            id.paid_amount, id.payment_status, c.course_title, cst.cust_code 
...
$total_remaining += ($row['due_amount'] - $row['paid_amount']);
    ...
    echo "<div>" . htmlspecialchars($row['course_title']) . "</div>";
    echo "<div>" . htmlspecialchars($row['cust_code']) . "</div>";
