...
INNER JOIN instructors i ON qi.instructor_id = i.inst_id 
...
<form id="contractForm" action="view_contract.php" method="post" target="view_contract_tab" enctype="multipart/form-data">
    ...
    <label for="course_select">Training Course Title:
      <select name="course_title" id="course_select" required>
    ...
    <label for="signature_upload">Upload Instructor Signature (PNG only):
      <input type="file" name="signature_image" id="signature_upload" accept="image/png" required>
    </label>
