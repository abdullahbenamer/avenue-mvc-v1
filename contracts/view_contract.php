...
<body>
  <div>
    <img src="../resources/logo.png" width="300px" alt="AVENUE INTERNATIONAL">
  </div>
  <button class="print-button" id="printButton" onclick="window.print()">Print Contract</button>

  <h2>INSTRUCTOR CONTRACT AGREEMENT</h2>

  <p>This Agreement is made and entered into on the <strong><?= $contract_date ?></strong> by and between AVENUE INTERNATIONAL LLC FZ, with its principal office located at DUBAI, UAE, and THE INSTRUCTOR <strong><?= $instructor ?></strong>, located in <strong><?= strtoupper($location) ?></strong>.</p>
  ...
  <div class="signature-block">
    <p><strong>AVENUE INTERNATIONAL</strong><br>
    Name: OSAMA ELFEITORI<br>
    Title: CEO<br>
    <div style="display: inline-flex; align-items: top;">Signature: <img src="osama_signature_light.png" width="150px"></div><br>
    Date: <?= $contract_date ?></p>
    <hr>
    <p><strong>INSTRUCTOR</strong><br>
    Name: <?= strtoupper($instructor) ?><br>
    <div style="display: inline-flex; align-items: top;">Signature: <?= $signatureImgTag ?></div><br>
    Date: <?= $contract_date ?></p>
  </div>
  ...
  <p style="color: red;">The following bank account details were provided by the Instructor for payment processing:</p>
