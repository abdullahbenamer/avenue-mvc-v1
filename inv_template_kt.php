...
<table class="invoice-breakdown">
    <tr>
        ...
        <th class="wrap">Cost per<br>Candidate</th>
    ...
    ?>
        ...
        <td class="cost"><strong><?php echo number_format($invoice['cost'], 0); ?></strong></td>
        <td class="candidates"><strong><?php echo $invoice['trainees']; ?></strong></td>
        <!-- Calculate the total dynamically -->
        <?php $calculated_total = $invoice['cost'] * $invoice['trainees']; ?>
        <td class="amount"><strong><?php echo number_format($calculated_total, 0); ?></strong></td>
    </tr>
    ...
    <tr class="subtotal-row">
        ...
        <td class="amount" style="text-align: right; background-color: #f0f0f0;"><?php echo number_format($calculated_total, 0); ?></td>
    </tr>

    <tr>
        <td colspan="2"></td>
        <td style="text-align: right;"><b>GRAND TOTAL</b></td>
        <td class="amount" style="text-align: right;"><h4>US$<?php echo number_format($calculated_total, 0); ?></h4></td>
    </tr>

    <!-- Amount in Words Section -->
    <tr>
        <td colspan="4" style="text-align: center;">
            <i>Amount in words: <span style="color: #CC0A0B; font-weight: 600;"><?php echo strtoupper(convert_number_to_words($calculated_total)); ?> US DOLLARS ONLY</span></i>
        </td>
    </tr>
</table>
 ...
 <br>
    ...
    <table class="bank-info">
        <tr>
          ...
          <tr>
            <th>Bank Name</th>
            <td colspan="2">KUVEYT TüRK PARTICIPATION BANK INC</td>
        </tr>
        <tr>
            <th>Account Name</th>
            <td colspan="2">AVENUE INTERNATIONAL EĞITIM DANIŞMANLIK HIZMETLERI TICARET LIMITED ŞIRKETI</td>
        </tr>
         <tr>
            <th>Bank Branch</th>
            <td colspan="2">OSMANBEY BRANCH MESRUTIYET MAH. HALASKAGAZI CAD .NO: 100/B Şişli, İSTANBUL, Türkiye</td>
        </tr>
        <tr>
            <th>Account Number</th>
            <td colspan="2">95588094</td>
        </tr>
               <tr>
            <th>IBAN</th>
            <td colspan="2">TR66 0020 5000 0955 8809 4001 01</td>
        </tr>
        <tr>
            <th>SWIFT Code</th>
            <td colspan="2">KTEFTRISXXX</td>
        </tr>
         <tr>
            <th>Account Type</th>
            <td colspan="2">USD</td>
